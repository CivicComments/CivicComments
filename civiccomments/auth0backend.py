...
class Auth0(BaseOAuth2):
    ...
    def get_management_api_token(self):
        ...
        response = requests.post("https://civiccomments.auth0.com/oauth/token", data=payload, headers=headers)
        print response.text
    ...
    def get_user_details(self, response):
        ...
        url = 'https://civiccomments.auth0.com/api/v2/users/' + userinfo['sub']
        resp = requests.get(url, headers=headers)
